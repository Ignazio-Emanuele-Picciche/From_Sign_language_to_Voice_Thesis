...
# --hidden_size 256 \
# --num_layers 1 \
# --learning_rate 2.2397416974947544e-05 \
# --dropout 0.7388298504593507 \
# --weight_decay 0.19006466364096877 \
# --num_epochs 100 \
# --patience 20 \
# --seed 42 \
# --downsample_ratio 1.0 \
...
def main(args):
    ...
    with mlflow.start_run(run_name=run_name) as run:
        params = {
            ...
            "patience": args.patience,
            "seed": args.seed,
            # "loss_function": "FocalLoss", # Vecchia loss
            # "focal_alpha": 0.5975773894779193,
            # "focal_gamma": 2.8722138431333333,
            "loss_function": "CrossEntropyLoss",  # Nuova loss
