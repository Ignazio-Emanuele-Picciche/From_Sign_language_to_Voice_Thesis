...
#
#    python src/models/3classes/vivit/hyperparameter_tuning_vivit.py --n_trials 20 --num_epochs 7 --downsample_ratio 1.0 --num_workers 2
#
# =================================================================================================
...
# experiment_name = "ViViT - 3-Class Hyperparameter Tuning"
...
TRAIN_ANNOTATIONS_FILES = [
    ...
    os.path.join(
        ...
        "data",
        "processed",
        "asllrp_video_sentiment_data_with_neutral_0.34_without_golden.csv",  # Assuming this file exists for 3 classes
    ),
]
...
def main():
    ...
    mlflow.set_tracking_uri("http://127.0.0.1:8080")
    base_experiment_name = "VIVIT - 3-Class HT Emotion Recognition"
