# =================================================================================================
# TEST SCRIPT PER GOLDEN LABELS CON MODELLO VIVIT
# =================================================================================================
#
# Questo script testa il modello ViViT addestrato sui golden labels.
...
def print_detailed_results(y_true, y_pred, y_probs, labels, video_names=None):
    ...
    """
    print("\n" + "=" * 70)
    print("RISULTATI TEST GOLDEN LABELS - MODELLO VIVIT")
    print("=" * 70)
...
def main(args):
    """
    Funzione principale per il test dei golden labels con ViViT
    """
    print("=" * 80)
    print("TEST GOLDEN LABELS CON MODELLO VIVIT")
    print("=" * 80)
    ...
    if args.save_results:
        ...
        f1_class_file = os.path.join(
            BASE_DIR, "results", "vivit_golden_labels_f1_per_class_3_classes.csv"
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Test del modello ViViT sui Golden Labels"
    )
    parser.add_argument(
